...
public class UpdateHandler extends ControlThread implements Logging {
     ...
     */
    public final static String RCSID = "$Id: UpdateHandler.java,v 1.9 2005-05-27 14:00:42 snf Exp $";
     ...
     * @see #elapsedTime
     */
    public UpdateHandler(TelescopeEmbeddedAgent tea, 
			 AgentRequestHandler    arq, 
			 RTMLDocument           baseDoc) throws Exception
	{
	    super("UH", true);
	    this.tea     = tea;
	    this.arq     = arq;
