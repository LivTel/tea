...
// 		}
	    ...
	    tea.addDocument(obsPathName, document);
    	    ...
    	    traceLog.log(INFO, 1, CLASS, id, "exec", "ARQ:Error occurred: "+ex);   	
    ...
    /** Send a reply of specified type - same as sendDoc(doc,type) - weird !.*/
    public void sendDocUpdate(RTMLDocument document, String type) {
